...
4. [Start, stop, and check the status of network services](https://github.com/antrianis/LFCS-official/blob/main/stuff/Networking.md#start-stop-and-check-the-status-of-network-services)
5. [Statically route IP traffic](https://github.com/antrianis/LFCS-official/blob/main/stuff/Networking.md#statically-route-ip-traffic)
6. [Synchronize time using other network peers](https://github.com/antrianis/LFCS-official/blob/main/stuff/Networking.md#synchronize-time-using-other-network-peers)
